...
Accepted strict public estimates and aggregate coverage enter an evidence index and profiles. A reviewed definition registry and exact endpoint provenance govern descriptive comparisons. Typed, canonical Spanish claims and a strict analytical packet become the input to Phase 4 publication. No person rows, internal diagnostic estimate payloads, arbitrary prose, source activation or unchecked geography equivalence cross those boundaries.

## Authored register

Plans did not assign severities; integrity and disclosure threats are conservatively high. Accepted no-install dependency dispositions remain limited to their plan scope and do not substitute for the final license/package audit.
...
| 02 / T-03-06 | geography alias | high | mitigate | Exact 32 code/name mapping and official cross-boundary evidence with negative key/name fixtures. | CLOSED — CR-01 corrected at 79dbd25: an independent eight-snapshot map pins exact period/native field/catalog; original coherent tamper now blocks with null changes. Independent recheck passes 21 comparison tests and two Node controls; canonical p3/p4 proofs pass. |
...
Close a mitigation only after source and affected checks prove it. Reuse the independent code review and canonical bad/clean prohibition evidence after implementation. All high findings must be closed before phase acceptance. The absence of source changes or a generated packet alone is not proof. No integrity or disclosure gap is accepted as risk.
