...
- Source freeze: `ab01b14`. The first fresh wheel SHA-256 was `933d770d13b2a1af647d1462c2719840aeb17e6fb0b5dab26383d2e39f2230e1`; it was installed under `${TEMP}/brujula-0402-installed` and invoked outside the checkout. It resolved 11 fixed package code/oracle paths, seven fixed numerical resources, eight current acquisition receipts, R 4.6.1, and survey 4.5 from the explicit `.cache/R-library`. No checkout resource fallback was accepted.
